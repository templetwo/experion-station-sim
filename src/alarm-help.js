...
(function (root, factory) {
  ...
  var TABLE = {
    ...
    'TI216.PVHH': e(RT.now,
      ...
      'Confirm the feed is shed and the sequence is HELD, restore agitation and jacket cooling, and RESUME only when TI216 is back below the High limit.'),
    ...
    'H-310.TUBE SKIN TRIP': e(RT.now,
      'Fuel gas is shut off; the preheater cools and the bed reaction dies out; restart only after both tube skins are below 420 DEG C.',
