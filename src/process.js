...
(function (root, factory) {
  ...
  var TEXT = [
    ...
    'You will get used to it. Every plant you have ever worked was the same.',
    '',
    ...
    'runs out of jacket cooling. TK-101 is a surge vessel and it is meant to',
    'swing. Do not chase it.',
    '',
    ...
    '',
    'AI205 reads per-pass conversion, nominally 85 percent, and its target',
    'band is 75 to 95. It is your health indicator for this reactor.',
    '',
    ...
    'PV-401 at about 600 KPA. The level in V-401 is a liquid seal. Lose it and',
    'gas blows through LV-401 into the liquid line. Flood it and liquid',
    ...
    'across a shift to hold the same outlet temperature. When it saturates,',
    'the flash duty changes and PIC401 starts to work.',
    '',
    ...
    '',
    'R-202 is a jacketed semi-batch reactor with a dosed feed and an external',
    'heat exchanger, run under sequence control by SCM202. It is not in the',
    ...
    'until 70. Losing the agitator M202 during FEED is the worst case: the',
    'contents stop mixing while feed is still going in.',
    '',
    ...
    'residual unsaturates and removes residual oxygen.',
    '',
    ...
    'TI315 reads pass 2. A fouled or low-flow pass runs its tubes hot while',
    'the mixed outlet still looks perfectly normal, which is exactly why both',
    'skins are on the board. The two passes do not share limits: pass 1 is',
    ...
    '',
    'FIC313 is the interbed quench. When TI312 starts to climb, BACK OFF THE',
    'HEATER BEFORE YOU LEAN ON QUENCH. Quench cools the bed inlet, but the',
    'heat is being made inside the bed, and the only way to make less of it is',
    'to send in less feed at a lower temperature.',
    '',
